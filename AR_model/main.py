...
if  model_tested =='FFNN_AR':
    ...
    #################calculate metrics
    rmse=rmse(X_test_sc[horizon:,0], preds_test[0,:,0].detach().numpy(), metricspath)
...
# =============================================================================    
     ...
     labels=np.concatenate((labels_test[0,:,:1], labels_test[0,:,2:]), axis=1)
     rmse=rmse(labels, preds_test[0,:,:].detach().numpy(), metricspath)
