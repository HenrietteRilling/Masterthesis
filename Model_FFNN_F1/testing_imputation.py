...
model.load_state_dict(torch.load(os.path.join(respath,'weights_0.pth')))
model.eval()
...
TOP2idx=np.where(dates=='2022-06-08')[0][0]
...
TOP3idx=np.where(dates=='2022-06-16')[0][0]
...
TOP4idx=np.where(dates=='2022-06-24')[0][0]
